/**
 * Cloudflare Worker Independiente: Contact Form Processor
 * Exporta handler fetch para despliegue directo con Wrangler.
 */
...
function isAllowedOrigin(request, env) {
  ...
  if (requestDomain.startsWith('localhost') || requestDomain.startsWith('127.0.0.1')) return true;
  if (host && requestDomain === host.toLowerCase()) return true;
